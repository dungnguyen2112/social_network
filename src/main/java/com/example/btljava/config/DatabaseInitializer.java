    ...
    public void run(String... args) throws Exception {
        ...
        if (countPermissions == 0) {
            ...
            arr.add(new Permission("Unlike a post",
                    "/api/v1/unlike/posts/{postId}/{userId}", "DELETE", "LIKES"));
            arr.add(new Permission("Get liked posts by user",
                    "/api/v1/like/posts/user/{userId}", "GET", "LIKES"));
            ...
            arr.add(new Permission("Unlike a comment",
                    "/api/v1/unlike/comments/{commentId}/{userId}", "DELETE",
                    "LIKES"));
            arr.add(new Permission("Get liked comments by user",
                    "/api/v1/like/comments/user/{userId}", "GET",
                    "LIKES"));
        ...
        if (countRoles == 0) {
            ...
            userPermissions.add(this.permissionRepository.findByName("Fetch all posts with pagination and filtering"));
